...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_EVOLUTION_MART] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FORGOTTEN_CAVE] = MAPPOPUP_THEME_STONE,         
    [MAPSEC_BERRYGOD_SHRINE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEAFOAM_CAVE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FIERY_CAVE] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_JUNGLE_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AURORA_CAVE] = MAPPOPUP_THEME_UNDERWATER,
