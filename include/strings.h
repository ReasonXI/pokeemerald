...
extern const u8 gText_RazzBerry[];
extern const u8 gText_BlukBerry[];
extern const u8 gText_NanabBerry[];
extern const u8 gText_WepearBerry[];
extern const u8 gText_PinapBerry[];
extern const u8 gText_CornnBerry[];
extern const u8 gText_MagostBerry[];
extern const u8 gText_RabutaBerry[];
extern const u8 gText_NomelBerry[];
extern const u8 gText_SpelonBerry[];
extern const u8 gText_PamtreBerry[];
extern const u8 gText_WatmelBerry[];
extern const u8 gText_DurinBerry[];
extern const u8 gText_BelueBerry[];
